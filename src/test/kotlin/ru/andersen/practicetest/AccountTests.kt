...
class AccountTests {
    ...
    private val account1 = Account(id = 1L, beneficiary = Beneficiary(name = "Test1"), pinCode = "0000", createdAt = Instant.now())
    private val account2 = Account(id = 2L, beneficiary = Beneficiary(name = "Test2"), pinCode = "1111", createdAt = Instant.now())
